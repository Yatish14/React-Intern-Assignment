  ...
  return (
    <div className='singleshow'>
        <Card style={{ width: '300px', margin: 20}}>
            <Card.Img className='img' variant="top" src={val.image} alt={val.name} style={{height: 300,width: 300,objectfit: "contain"}}/>
          ...
          </Link> */}<Button variant="primary" onClick={handleGetDetailsClick}>
              Get Details</Button>
          {showDetailsVisible && (
            <ShowSummary data={val} onClose={() => setShowDetailsVisible(false)}/>)}
            </Card.Body>
